                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            ...
                            <img class="img-fluid" src="{{asset('assets/no-image.jpg')}}" alt="">
                            @else
                            <img class="img-fluid" src="{{$index->donasi->getImageAttribute()}}" alt="">
                            @endif
                            <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="">{{$index->donasi->title}}</a>
                        </div>
                        <div class="p-4">
                            <div class="d-flex mb-3">
                                {{-- <small class="me-3"><i class="far fa-user text-primary me-2"></i>{{$index->target_donasi}}</small> --}}
                                <small><i class="far fa-calendar-alt text-primary me-2"></i>{{$index->created_at}}</small>
                            </div>
                            <h4 class="mb-3">{{$index->title}}</h4>
