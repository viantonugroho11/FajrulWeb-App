																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span
																				style="font-size:30px;"><strong><span style="">Terima Kasih Telah
																						Donasi</span></strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			Anda Berdonasi untuk :<br /><br />Dengan Nominal :<br /><br /><strong><span
																					style="font-size:15px;">{{$data['nominal']}}</span></strong></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
																		<p style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			Berikut Adalah Kode Unik Untuk melakukan Konfirmasi : {{$data['kode_verif']}}<br />Atau Bisa
																			Langsung Klik Tombol Dibawah ini</p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad"
																...
																<div align="left" class="alignment">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com/" style="height:46px;width:177px;v-text-anchor:middle;" arcsize="35%" stroke="false" fillcolor="#506bec"><w:anchorlock/><v:textbox inset="5px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:15px"><![endif]--><a
																		...
																		target="_blank"><span
																			style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
																				dir="ltr" style="word-break: break-word;"><span data-mce-style="" dir="ltr"
																					style="line-height: 30px;"><strong>Konfirmasi
																						Donasi</strong></span></span></span></a>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" class="alignment" style="line-height:10px"><img
																		...
																		title="Card Bottom with Border and Shadow Image" width="600" /></div>
															</td>
														</tr>
													</table>
												</td>
										...
										<tbody>
											<tr>
												<td class="column column-1"
														...
														<tr>
															<td class="pad">
																<div align="center" class="alignment" style="line-height:10px"><a
																		...
																		target="_blank"><img alt="Your Logo" src="images/logo.png"
																			style="display: block; height: auto; border: 0; width: 145px; max-width: 100%;"
																			title="Your Logo" width="145" /></a></div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="10" cellspacing="0" class="social_block block-2"
														role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
														<tr>
															<td class="pad">
																<div class="alignment" style="text-align:center;">
																	<table border="0" cellpadding="0" cellspacing="0" class="social-table"
																		...
																		width="72px">
																		<tr>
																			<td style="padding:0 2px 0 2px;"><a href="https://www.instagram.com/"
																					target="_blank"><img alt="Instagram" height="32" src="images/instagram2x.png"
																						...
																						width="32" /></a></td>
																			<td style="padding:0 2px 0 2px;"><a href="https://www.twitter.com/"
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
																			This link will expire in the next 24 hours.<br />Please feel free to contact us at
													...
													<table border="0" cellpadding="10" cellspacing="0" class="text_block block-5"
														role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:12px;">Copyright© 2021 Your Brand.</span></p>
																		<p id="m_8010100107078456808text01"
																			style="margin: 0; text-align: center; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			<span style="font-size:12px;"><a href="http://www.example.com/" rel="noopener"
																					style="text-decoration: underline; color: #97a2da;" target="_blank"
																					title="Unsubscribe ">Unsubscribe</a> | <a href="http://www.example.com/"
																					rel="noopener" style="text-decoration: underline; color: #97a2da;"
																					target="_blank" title="Manage your preferences">Manage your
																					preferences</a> | <a href="http://www.example.com/" rel="noopener"
																					style="text-decoration: underline; color: #97a2da;" target="_blank"
