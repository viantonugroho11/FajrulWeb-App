...
<body style="background: url(&quot;/assets/img/bg-aurora-full.png?h=6e7d0ed6e480a49d3f54140d74d327d5&quot;);background-size: cover;font-family: Poppins, sans-serif;">
            ...
            <div class="col-md-6 align-self-center" style="padding: 0;font-family: Poppins, sans-serif;background: rgba(255,255,255,0);">
                <div class="card" style="border-style: none;background: rgba(255,255,255,0);">
                    <div class="card-body" style="border-style: none;background: rgba(255,255,255,0);">
                        <h4 class="card-title" style="border-style: none;font-family: Poppins, sans-serif;font-weight: bold;font-size: 44px;background: rgba(255,255,255,0);">Title</h4>
                        <p class="card-text" style="border-style: none;">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p><button class="btn btn-primary" type="button" style="background: rgba(47, 49, 61, 1);height: 50px;width: 210px;color: rgba(243, 243, 243, 1);border-radius: 30px;box-shadow: 0px 6px 20px rgba(47,49,61,0.25);border-style: none;">Lihat Selengkapnya</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 align-self-center" style="text-align: center;padding: 0;">
                <div class="card" style="border-style: none;background: rgba(255,255,255,0);">
                    <div class="card-body" style="border-style: none;text-align: center;background: rgba(255,255,255,0);">
                        <h4 class="card-title" style="border-style: none;text-align: center;font-size: 44px;font-family: Poppins, sans-serif;margin-bottom: 2rem;font-weight: bold;">10+ Program Kerja<br>Terealisasikan</h4><button class="btn btn-primary" type="button" style="background: rgba(47, 49, 61, 1);text-align: center;height: 50px;width: 210px;border-radius: 30px;border-style: none;box-shadow: 0px 6px 20px rgba(47, 49, 61, 0.25);">Lihat Selengkapnya</button>
                    </div>
                </div>
            </div>
                ...
                <div class="card-group" style="width: 1200px;height: 500px;padding: 2%;color: rgba(243, 243, 243, 1);font-family: Poppins, sans-serif;">
                    <div class="card d-xxl-flex" style="margin: 1rem;border-radius: 20px;background: rgba(243,243,243,0.2);">
                        <div class="card-body" style="text-align: right;">
                            <h4 class="card-title" style="text-align: left;background: rgba(243,243,243,0);font-size: 30px;">Title</h4>
                            <p class="card-text" style="text-align: left;background: rgba(243,243,243,0);">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p><button class="btn btn-primary" type="button" style="background: rgba(13,110,253,0);border-style: none;">Button</button>
                        </div>
                    </div>
                    ...
                    <div class="card" style="margin: 1rem;border-radius: 20px;background: rgba(243,243,243,0.2);">
                        <div class="card-body" style="text-align: right;">
                            ...
                            <p class="card-text" style="text-align: left;">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p><button class="btn btn-primary" type="button" style="background: rgba(13,110,253,0);border-style: none;">Button</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container" style="background: rgba(255,255,255,0);margin-bottom: 9rem;font-family: Poppins, sans-serif;">
        <!-- Start: Newsletter Subscription Form -->
        <section class="newsletter-subscribe" style="background: rgba(255,255,255,0);margin-bottom: 0px;">
            <div class="container">
                <!-- Start: Intro -->
                <div class="intro" style="width: 1272px;">
                    <h2 class="text-center" style="color: rgba(47, 49, 61, 1);font-size: 44px;">Tetap Terhubung dengan Kami</h2>
                    <p class="text-center">agar kamu tetap update infromasi dari kami </p>
                </div><!-- End: Intro -->
                <form class="d-flex justify-content-center flex-wrap" method="post">
                    <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Your Email" style="margin: 0px;border-radius: 10px;height: 53px;border-top-right-radius: 0;border-bottom-right-radius: 0;color: rgba(47, 49, 61, 1);border-style: solid;border-color: rgba(47, 49, 61, 1);border-top-color: rgba(47,;border-right-color: 49,;border-bottom-color: 61,;border-left-color: 1);"><button class="btn btn-primary" type="button" style="background: linear-gradient(rgba(47, 49, 61, 1) 100%, rgba(47, 49, 61, 1) 100%), rgba(47, 49, 61, 1);color: #f3f3f3;height: 53px;border-top-right-radius: 10px;border-bottom-right-radius: 10px;border-top-left-radius: 0px;border-bottom-left-radius: 0px;border-color: rgba(47, 49, 61, 1);border-top-color: rgba(47,;border-right-color: 49,;border-bottom-color: 61,;border-left-color: 1);">TERHUBUNG!</button></div>
                </form>
            </div>
