...
@section('content')
  <div class="container" style="margin-bottom: 9rem;">
    <div class="row">
      <div class="col-md-6 align-self-center" style="padding: 0;text-align: center;"><img
          src="/assets/img/about-lp-img.png?h=daa792aaee5dee417b39dfbf0a598566" style="width: 80%;height: auto;"></div>
      <div class="col-md-6 align-self-center"
        style="padding: 0;font-family: Poppins, sans-serif;background: rgba(255,255,255,0);">
        <div class="card" style="border-style: none;background: rgba(255,255,255,0);">
          <div class="card-body" style="border-style: none;background: rgba(255,255,255,0);">
            <h4 class="card-title"
              style="border-style: none;font-family: Poppins, sans-serif;font-weight: bold;font-size: 44px;background: rgba(255,255,255,0);">
              Title</h4>
            <p class="card-text" style="border-style: none;">Nullam id dolor id nibh ultricies vehicula ut id elit.
              ...
              style="background: rgba(47, 49, 61, 1);height: 50px;width: 210px;color: rgba(243, 243, 243, 1);border-radius: 30px;box-shadow: 0px 6px 20px rgba(47,49,61,0.25);border-style: none;">Lihat
              Selengkapnya</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 align-self-center" style="text-align: center;padding: 0;">
        <div class="card" style="border-style: none;background: rgba(255,255,255,0);">
          <div class="card-body" style="border-style: none;text-align: center;background: rgba(255,255,255,0);">
            <h4 class="card-title"
              style="border-style: none;text-align: center;font-size: 44px;font-family: Poppins, sans-serif;margin-bottom: 2rem;font-weight: bold;">
              10+ Program Kerja<br>Terealisasikan</h4><button class="btn btn-primary" type="button"
              style="background: rgba(47, 49, 61, 1);text-align: center;height: 50px;width: 210px;border-radius: 30px;border-style: none;box-shadow: 0px 6px 20px rgba(47, 49, 61, 0.25);">Lihat
              Selengkapnya</button>
          </div>
        </div>
      </div>
      <div class="col-md-6 align-self-center" style="padding: 0;"><img
          src="/assets/img/proker-img.png?h=e8fdf7d7c8a9466a54334e46a39c8322" style="width: 80%;height: auto;"></div>
    </div>
  </div><!-- End: 1 Row 2 Columns -->
  ...
  <div class="container" style="margin-bottom: 9rem;">
    <div class="row">
      ...
      <div class="col d-xxl-flex justify-content-xxl-end align-items-xxl-center">
        <div class="card" style="border-style: none;background: rgba(255,255,255,0);">
          <div class="card-body" style="text-align: right;font-size: 23px;"><a class="card-link" href="#"
              style="color: rgb(2,20,45);font-family: Poppins, sans-serif;border-style: none;">More &gt;</a></div>
        </div>
      </div>
    </div>
        ...
        <div class="card-group"
          ...
          <div class="card d-xxl-flex" style="margin: 1rem;border-radius: 20px;background: rgba(243,243,243,0.2);">
            <div class="card-body" style="text-align: right;">
              ...
              <p class="card-text" style="text-align: left;background: rgba(243,243,243,0);">Tidak ada acara</p><button class="btn btn-primary" type="button"
                style="background: rgba(13,110,253,0);border-style: none;">Button</button>
            </div>
          </div>
          @endforelse
